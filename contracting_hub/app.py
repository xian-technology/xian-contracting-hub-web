...
def _load_pages() -> tuple[tuple[str, object, str, object | None], ...]:
    ...
    admin_catalog_operations_module = importlib.import_module(
        "contracting_hub.admin.catalog_operations"
    )
    ...
    admin_contract_relations_module = importlib.import_module(
        "contracting_hub.admin.contract_relations"
    )
    ...
    return (
        ...
        (
            admin_catalog_operations_module.ROUTE,
            admin_catalog_operations_module.index,
            f"Admin Catalog Operations | {meta_module.APP_NAME}",
            admin_catalog_operations_module.ON_LOAD,
        ),
        (
        ...
        (
            admin_contract_relations_module.ROUTE,
            admin_contract_relations_module.index,
            f"Contract Relations | {meta_module.APP_NAME}",
            admin_contract_relations_module.ON_LOAD,
        ),
    )
