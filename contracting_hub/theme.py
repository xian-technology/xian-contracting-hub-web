...
SHADOW_TOKENS: dict[str, str] = {
    "panel": "0 24px 60px rgba(40, 31, 17, 0.08)",
    "header": "0 12px 30px rgba(40, 31, 17, 0.06)",
}
...
APP_STYLE: dict[str, str] = {
    ...
    **_css_variables("layout", LAYOUT_TOKENS),
    "background": (
        "radial-gradient(circle at top left, rgba(188, 123, 40, 0.18), transparent 36%), "
        "radial-gradient(circle at top right, rgba(77, 122, 51, 0.14), transparent 34%), "
        "linear-gradient(180deg, #f7f1e5 0%, #f0e6d5 100%)"
    ),
