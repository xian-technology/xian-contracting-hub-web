...
from contracting_hub.admin.contract_relations import ROUTE
from contracting_hub.admin.contract_relations import index as admin_contract_relations_page
...
def test_app_registers_admin_contract_relation_manager_route(app_module: dict[str, object]) -> None:
    assert ROUTE.lstrip("/") in app_module["app"]._unevaluated_pages


def test_admin_contract_relation_manager_page_renders_admin_sections() -> None:
    rendered = admin_contract_relations_page().render()
